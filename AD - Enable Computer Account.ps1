...
# Type: New Service
#
# Title: AD - Enable Computer Account
#
# v 1.0 Initial Release
# v 1.1 Added Stored Credentials
#       see for details: https://au2mator.com/documentation/powershell-credentials/?utm_source=github&utm_medium=social&utm_campaign=AD_EnableComputer&utm_content=PS1
...
# Code Template V 1.3
#
# URL: https://au2mator.com/enable-computer-account-active-directory-self-service-with-au2mator/?utm_source=github&utm_medium=social&utm_campaign=AD_EnableComputer&utm_content=PS1
# Github: https://github.com/au2mator/AD-Enable-Computer-Account
#################
...
[string]$LogPath = "C:\_SCOworkingDir\TFS\PS-Services\AD - Enable Computer Account"
[string]$LogfileName = "Enable Computer Account"

[string]$CredentialStorePath = "C:\_SCOworkingDir\TFS\PS-Services\CredentialStore" #see for details: https://au2mator.com/documentation/powershell-credentials/?utm_source=github&utm_medium=social&utm_campaign=AD_EnableComputer&utm_content=PS1
...
# Stored Credentials
# See: https://au2mator.com/documentation/powershell-credentials/?utm_source=github&utm_medium=social&utm_campaign=AD_EnableComputer&utm_content=PS1
...
Write-au2matorLog -Type INFO -Text "Try to enable AD Computer"
try {
    Enable-ADAccount -Identity $c_Computer -Confirm:$false
    Write-au2matorLog -Type INFO -Text "Computer enabled"

    $au2matorReturn = "Computer $((Get-ADComputer -identity $c_Computer).Name) enabled"
    $AdditionalHTML = "<br>
        Computer $((Get-ADComputer -identity $c_Computer).Name) has been enabled
        <br>
        "
    $Status = "COMPLETED"
}
catch {
    Write-au2matorLog -Type ERROR -Text "Not able to enable Computer"
    Write-au2matorLog -Type ERROR -Text $Error

    $au2matorReturn = "failed to enable Computer $((Get-ADComputer -identity $c_Computer).Name), Error: $Error"
    $AdditionalHTML = "<br>
        failed to enable Computer $((Get-ADComputer -identity $c_Computer).Name)
        <br>
        Error: $Error
        "
    $Status = "ERROR"
